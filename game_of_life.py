...
class Life:
    ...
    def __init__(self):
        ...
        self.num_species = 4
        self.particles_per_species = 160
        self.total_particles = self.num_species * self.particles_per_species

        # particle parameters
        self.repelling_force = 18 # force active if r < separation radius
        self.temperature = 8 # controls random fluctuations in particle velocities
        self.friction_coefficient = 100
        self.separation_radius = 8 # mean separation radius
        self.interaction_radius = 20 # mean interaction radius
        self.force_strength = 25 # inter-particle force strength
        self.close_range_factor = 3 # force strength multiplier at r=0
